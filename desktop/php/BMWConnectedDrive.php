...
<div class="row row-overflow">
  ...
  <legend><i class="fas fa-table"></i> {{Mes BMW}}</legend>
...
?>
	...
	<div class="form-group">
     ...
     <div class="form-group">
        <label class="col-sm-3 control-label">{{Vehicle Identification Number (VIN)}}</label>
        <div class="col-sm-3">
            <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="bmw_vin" placeholder="param1"/>
        </div>
     </div>
     <div class="form-group">
     ...
     <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="bmw_username" placeholder="param1"/>
        </div>
     </div>
     <div class="form-group">
